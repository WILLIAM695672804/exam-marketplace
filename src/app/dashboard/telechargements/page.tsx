      ...
      <div className="max-w-container-max mx-auto w-full">
        <div className="mb-12">
          ...
          <p className="font-body-md text-body-md text-on-surface-variant">
            Accedez a vos epreuves et corriges telechargeables.
          </p>
        </div>
                ...
                {downloads.map((d) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <a
                        href={`/api/download?orderItemId=${d.orderItemId}&type=paper`}
                        className="py-2 px-4 bg-primary text-on-primary font-label-caps text-label-caps uppercase hover:bg-inverse-surface transition-colors flex items-center gap-2"
                      >
